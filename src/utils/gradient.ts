...
class MiniGl {
  ...
  private gl:  any;
  private meshes:  any;
  private lastDebugMsg:  any;
  private debug:  any;
  private commonUniforms:  any;

  constructor(canvas:any, width:number, height:number, debug = false) {
            ...
            setTopology(e = 1, t = 1) {
              ...
              for (let e = 0; e <= n.ySegCount; e++)
                for (let t = 0; t <= n.xSegCount; t++) {
                  ...
                  if (
                    ((n.attributes.uv.values[2 * i] = t / n.xSegCount), (n.attributes.uv.values[2 * i + 1] = 1 - e / n.ySegCount), (n.attributes.uvNorm.values[2 * i] = (t / n.xSegCount) * 2 - 1), (n.attributes.uvNorm.values[2 * i + 1] = 1 - (e / n.ySegCount) * 2), t < n.xSegCount && e < n.ySegCount)
                  ) {
...
/**
 * 初始化属性 (判断当前对象上是否存在属性名，如果存在就对这个属性进行赋值，如果不存在就添加上这个属性)
 * @description object 要修改的对象
 * @description propertyName 属性名
 * @description val 属性值
*/
